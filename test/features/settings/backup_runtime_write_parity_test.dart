...
void main() {
  ...
  Map<String, dynamic> root({
    ...
    return {
      ...
      BackupKeys.fuelTypeCars: const [],
      BackupKeys.parts: const [],
      BackupKeys.partCars: const [],
      BackupKeys.partUnits: const [],
      BackupKeys.services: services,
      BackupKeys.serviceCenters: const [],
      BackupKeys.gasStationChains: const [],
      BackupKeys.gasStationLocations: const [],
